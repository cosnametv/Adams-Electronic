...
export const FeaturedProducts = () => {
  ...
  useEffect(() => {
    const unsubscribe = productService.getProducts((allProducts) => {
      ...
      // ✅ Normalize image handling for ProductCard
      const fixedProducts = featuredProducts.map((p) => ({
        ...p,
        ...
        {products.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">
              The store is currently empty. Check back soon for our featured
              products!
            </p>
            <div className="space-y-4">
              <p className="text-sm text-gray-500">
                Are you an admin? Add products through the admin panel.
              </p>
              <a
                href="/admin/products"
