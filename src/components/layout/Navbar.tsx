...
return (
  <>
    {/* Mini Payment Info Navbar (Fixed & Responsive) */}
    <div className="fixed top-0 left-0 w-full z-50 bg-primary-600 text-white text-center text-xs sm:text-sm py-1 sm:py-1.5">
      Payments ONLY Done Via Paybill: 247247 | Account Number: 0700056557
    </div>

    {/* Top Navbar (Fixed below the mini navbar) */}
    <nav className="fixed top-4 sm:top-6 left-0 w-full z-40 bg-white/80 backdrop-blur-md border-b border-gray-200 shadow-sm transition-all duration-300">
